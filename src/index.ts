export { CustomResourceDefinition } from "./apiextensions.k8s.io/CustomResourceDefinition";
...
export { ClusterRole } from "./rbac.authorization.k8s.io/ClusterRole";
export { ClusterRoleBinding } from "./rbac.authorization.k8s.io/ClusterRoleBinding";
export { Role } from "./rbac.authorization.k8s.io/Role";
export { VolumeSnapshot } from "./snapshot.storage.k8s.io/VolumeSnapshot";
export { VolumeSnapshotClass } from "./snapshot.storage.k8s.io/VolumeSnapshotClass";
