...
class Cluster {
  ...
  constructor(obj: object) {
    if (!has(obj, "server")) {
      throw new Error(
        `Expected Cluster to have a "server" property with the URL`
      );
    }
    ...
    if (has(obj, "tls-server-name")) {
      if (typeof obj["tls-server-name"] !== "string") {
        throw new Error(
          `Expected property "tls-server-name" of Cluster to be a string`
        );
      }
    ...
    if (has(obj, "insecure-skip-tls-verify")) {
      if (typeof obj["insecure-skip-tls-verify"] !== "boolean") {
        throw new Error(
          `Expected property "insecure-skip-tls-verify" of Cluster to be true or false`
        );
      }
    ...
    if (has(obj, "certificate-authority")) {
      if (typeof obj["certificate-authority"] !== "string") {
        throw new Error(
          `Expected property "certificate-authority" of Cluster to a string`
        );
      }

      this.certificateAuthorityData = readFileSync(
        obj["certificate-authority"],
        "utf-8"
      );
    }
    ...
    if (has(obj, "certificate-authority-data")) {
      if (typeof obj["certificate-authority-data"] !== "string") {
        throw new Error(
          `Expected property "certificate-authority-data" of Cluster to a string`
        );
      }

      this.certificateAuthorityData = Buffer.from(
  ...
  constructor(obj: object) {
    if (has(obj, "client-certificate")) {
      if (typeof obj["client-certificate"] !== "string") {
        throw new Error(
          `Expected property "client-certificate" of User to a string`
        );
      }

      this.clientCertificateData = readFileSync(
        obj["client-certificate"],
        "utf-8"
      );
    }
    ...
    if (has(obj, "client-certificate-data")) {
      if (typeof obj["client-certificate-data"] !== "string") {
        throw new Error(
          `Expected property "client-certificate-data" of User to a string`
        );
      }

      this.clientCertificateData = Buffer.from(
        obj["client-certificate-data"],
        "base64"
      ).toString();
    }
    ...
    if (has(obj, "client-key-data")) {
      if (typeof obj["client-key-data"] !== "string") {
        throw new Error(
          `Expected property "client-key-data" of User to a string`
        );
      }

      this.clientKeyData = Buffer.from(
        obj["client-key-data"],
        "base64"
      ).toString();
    }
    ...
    if (has(obj, "act-as-groups")) {
      if (!Array.isArray(obj["act-as-groups"])) {
        throw new Error(
          `Expected property "act-as-groups" of User to an array`
        );
      }
      ...
      for (const group of obj["act-as-groups"]) {
        if (typeof group !== "string") {
          throw new Error(
            `Expected property "act-as-groups" of User to an array of strings`
          );
        }
    ...
    if (has(obj, "act-as-user-extra")) {
      if (
        typeof obj["act-as-user-extra"] !== "object" ||
        obj["act-as-user-extra"] === null
      ) {
        throw new Error(
          `Expected property "act-as-user-extra" of User to an array`
        );
      }
      ...
      for (const [key, value] of Object.entries(obj["act-as-user-extra"])) {
        if (typeof value !== "string") {
          throw new Error(
            `Expected property "act-as-user-extra" of User to a map of strings`
          );
        }
  ...
  constructor(raw: string) {
...

    {
      ...
      for (const cluster of config.clusters) {
        if (!has(cluster, "name")) {
          throw new Error(
            `Expected Config's "clusters" entry to have a "name" property`
          );
        }

        if (typeof cluster.name !== "string") {
          throw new Error(
            `Expected property "name" of a Config's "clusters" entry to be a string`
          );
        }

        if (!has(cluster, "cluster")) {
          throw new Error(
            `Expected Config's "clusters" entry to have a "cluster" property`
          );
        }

        if (typeof cluster.cluster !== "object" || cluster.cluster === null) {
          throw new Error(
            `Expected property "cluster" of a Config's "clusters" entry to an object`
          );
        }
...

    {
      ...
      for (const user of config.users) {
        if (!has(user, "name")) {
          throw new Error(
            `Expected Config's "users" entry to have a "name" property`
          );
        }

        if (typeof user.name !== "string") {
          throw new Error(
            `Expected property "name" of a Config's "users" entry to be a string`
          );
        }

        if (!has(user, "user")) {
          throw new Error(
            `Expected Config's "users" entry to have a "user" property`
          );
        }

        if (typeof user.user !== "object" || user.user === null) {
          throw new Error(
            `Expected property "user" of a Config's "users" entry to an object`
          );
        }
...

    {
      ...
      for (const context of config.contexts) {
        if (!has(context, "name")) {
          throw new Error(
            `Expected Config's "contexts" entry to have a "name" property`
          );
        }

        if (typeof context.name !== "string") {
          throw new Error(
            `Expected property "name" of a Config's "contexts" entry to be a string`
          );
        }

        if (!has(context, "context")) {
          throw new Error(
            `Expected Config's "contexts" entry to have a "context" property`
          );
        }

        if (typeof context.context !== "object" || context.context === null) {
          throw new Error(
            `Expected property "context" of a Config's "contexts" entry to an object`
          );
        }
        ...
        if (!has(context.context, "cluster")) {
          throw new Error(
            `Expected Config's "contexts" entry to have a "cluster" property`
          );
        }

        if (typeof context.context.cluster !== "string") {
          throw new Error(
            `Expected property "cluster" of a Config's "contexts" entry to be a string`
          );
        }
        ...
        if (!has(context.context, "user")) {
          throw new Error(
            `Expected Config's "contexts" entry to have a "user" property`
          );
        }

        if (typeof context.context.user !== "string") {
          throw new Error(
            `Expected property "user" of a Config's "contexts" entry to be a string`
          );
        }
        ...
        if (has(context.context, "namespace")) {
          if (typeof context.context["namespace"] !== "string") {
            throw new Error(
              `Expected property "namespace" of Context to a string`
            );
          }
    ...
    if (typeof config["current-context"] !== "string") {
      throw new Error(
        `Expected property "current-context" of Config to be a string`
      );
    }
